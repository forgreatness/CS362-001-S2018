			...
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
                           ...
                           String lame = appt.toString();
                           String string1 = appt.getEmailAddress();
                           assertEquals(emailAddress, string1);
                           appt.getRecurBy();
                           appt.setValid();
                        ...
                        if (methodName.equals("setValid"))
                        {
            				 ...
            				 int startHour1=ValuesGenerator.getRandomIntBetween(random1, -100, 100);
            				 int startMinute1=ValuesGenerator.getRandomIntBetween(random1, -120, 120);
            				 int startDay1=ValuesGenerator.getRandomIntBetween(random1, -60, 60);
			            	 int startMonth1=ValuesGenerator.getRandomIntBetween(random1, -24, 24);
            				 int startYear1=ValuesGenerator.getRandomIntBetween(random1, -2018, 2018);
                             Appt appt1 = new Appt(startHour1, startMinute1, startDay1, startMonth1, startYear1, title, description, emailAddress);
                             appt1.setValid();
